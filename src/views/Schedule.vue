          ...
          <v-tabs-items v-model="model">
            ...
            >
              <v-container>
                <v-row>
                  <v-col>
                    <h3 class="google-font">TensorFlow Open-Source Library or TensorFlow for Web</h3>
            ...
            <v-tab-item value="day2" :class="$vuetify.theme.dark ? 'black' : 'white'">
              <v-container>
                <v-row>
                  <v-col>
                    <h3 class="google-font">TensorFlow for Mobile </h3>
                    <!-- <p class="google-font" style="text-align:justify;">
            ...
            <v-tab-item value="day3" :class="$vuetify.theme.dark ? 'black' : 'white'">
              <v-container>
                <v-row>
                  <v-col>
                    <h3 class="google-font">TensorFlow for Production </h3>
                    <!-- <p class="google-font" style="text-align:justify;">
            ...
            <v-tab-item value="day4" :class="$vuetify.theme.dark ? 'black' : 'white'">
              <v-container>
                <v-row>
                  <v-col>
                    <h3 class="google-font"> TensorFlow for Research </h3>
                    <!-- <p class="google-font" style="text-align:justify;">
